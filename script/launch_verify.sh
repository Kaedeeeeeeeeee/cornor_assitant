...
ARCHIVE_PATH="${ARCHIVE_PATH:-/tmp/peek-appstore/Corner Peek.xcarchive}"
...
assert_plist_value "$INFO_PLIST" "CFBundleShortVersionString" "1.0.1"
assert_plist_value "$INFO_PLIST" "CFBundleVersion" "5"
