...
final class LaunchReadinessTests: XCTestCase {
    ...
    func testLaunchAutoRevealPolicyKeepsInitialPanelVisible() {
        XCTAssertGreaterThan(LaunchPresentationPolicy.autoRevealDelay, 0)
        XCTAssertLessThanOrEqual(LaunchPresentationPolicy.autoRevealDelay, 1)
    ...
    func testAppTargetBuildSettingsMatchStoreLaunchPlan() throws {
        ...
        XCTAssertEqual(project.count(of: "MARKETING_VERSION = 1.0.1;"), 6)
        XCTAssertEqual(project.count(of: "CURRENT_PROJECT_VERSION = 5;"), 6)
