...
#ifndef CORNERASSISTANTAPP_SWIFT_H
#define CORNERASSISTANTAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CornerAssistantApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18CornerAssistantApp11AppDelegate")
...
SWIFT_CLASS("_TtC18CornerAssistantApp19KeyboardAwareWindow")
@interface KeyboardAwareWindow : NSWindow
...
SWIFT_CLASS("_TtC18CornerAssistantApp12WebViewStore")
@interface WebViewStore : NSObject <WKNavigationDelegate, WKUIDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
